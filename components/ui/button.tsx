  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-white/80 bg-white/82 text-foreground shadow-[0_12px_28px_-22px_rgba(41,66,69,0.52)] hover:bg-white hover:text-primary dark:border-white/12 dark:bg-white/[0.06] dark:hover:bg-white/[0.1]",
        secondary:
          "border border-white/80 bg-white/82 text-secondary-foreground shadow-[0_12px_28px_-22px_rgba(41,66,69,0.46)] hover:bg-white hover:text-primary dark:border-white/12 dark:bg-white/[0.06] dark:text-white/82 dark:hover:bg-white/[0.1]",
        ghost:
