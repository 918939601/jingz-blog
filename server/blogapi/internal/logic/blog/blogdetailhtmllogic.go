...
type BlogDetailHtmlLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewBlogDetailHtmlLogic(ctx context.Context, svcCtx *svc.ServiceContext) *BlogDetailHtmlLogic {
	return &BlogDetailHtmlLogic{
...
func (l *BlogDetailHtmlLogic) BlogDetailHtml(req *types.BlogDetailReq) (*types.Blog, error) {
	...
	// In production, integrate with markdown rendering library
