...
type NoteDetailLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewNoteDetailLogic(ctx context.Context, svcCtx *svc.ServiceContext) *NoteDetailLogic {
...
func (l *NoteDetailLogic) NoteDetail(slug string) (*types.Note, error) {
